...
fn main() {
    let cl_matches = App::new("rcrawl")
        ...
        .arg(Arg::with_name("regex")
            .short("R")
            .long("regex")
            .help("A flag indicating wether the search expression is a regular expression")
        )
        .arg(Arg::with_name("verbose")
            .short("v")
            .long("verbose")
            .help("A flag indicating wether to print verbose information")
        )
        .arg(Arg::with_name("all")
            .short("a")
            .long("all")
            .help("A flag indicating wether to search all files including hidden files")
        )
        ...
        .arg(Arg::with_name("root_directory")
            .help("The name of the root directory to start searching from")
            .required(true)
            .index(1)
        )
